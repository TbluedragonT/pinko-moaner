    ...
    /***/ 605338: function (_, __, __webpack_require__) {
      ...
      (function (__c) {
        ...
        var q_b = function (a, b, c) {
          ...
          c4 = function (a, b) {
            a = a.e0a.get(b);
            if (a == null) throw new s_b("ref does not exists");
            return a;
          },
          f4 = function (a) {
            const b = (c, d) => {
            ...
            return {
              Bk: (c) => ({ type: "string", value: c }),
              ws: (c) => b(c, "toWidgetState"),
              vs: (c) => b(c, "toWidgetData"),
          ...
          h4 = function (a, b) {
            ...
            return {
              Bk: (e) => ({ type: "string", value: e }),
              ws: (e) => d(e, "toWidgetState"),
              vs: (e) => d(e, "toWidgetData"),
          ...
          i4 = function (a) {
            ...
            return {
              Bk: (c) => {
                if (!Number.isFinite(c)) throw new t_b(c);
          ...
          m4 = function (a) {
            return {
              Bk: (b) => ({ type: "list", value: b.map((c) => a.Bk(c)) }),
              ws: (b) => {
                if ((b === null || b === void 0 ? void 0 : b.type) !== "list")
                  throw new e4("list", b);
                return b.value.filter(Ib).map((c) => a.ws(c));
              },
              vs: (b) => {
                if ((b === null || b === void 0 ? void 0 : b.type) !== "list")
                  throw new d4("list", b);
          ...
          x_b = function (a) {
            const b = () => a.Ej.mz.get(a.Oe.iC) || o4;
            return {
              iT: function () {
                return a.Ej.Bj
                  ? 3
                  : a.Ej.Pgb === "checking" || a.Ej.settings.status === 2
                  ? 1
                  : a.Ej.settings.status === 3
                  ? 4
                  : a.Ej.F1
                  ? 2
                  : 0;
              ...
              ffb: function (c) {
                if (!a.Oe.fields.first(({ value: e }) => e.id === c)) return 0;
                var { results: d } = b();
          ...
          B_b = function (a, b, c, d, e, f) {
            ...
            async function h() {
              var v;
              const u = f.uh("submit_response", {
                yp: { name: "ui.rendering.form.submit_response" },
              });
              var x = {
                hqa: m,
                Odb: p,
              ...
              e && r_b({ span: u, ga: e, event: y_b, props: x });
              const { results: y, gf: A, Dwa: z } = r();
              if (A != null && g())
                if (
                  (x =
                    (v = a.Oe.fields.first(({ value: K }) => {
                      var M;
                      return !(
                        (M = K.options.first(({ value: Q }) => Q.id === A)) ===
                          null ||
                        M === void 0 ||
                        !M.value
                      );
                  ...
                  p === "poll" &&
                    z &&
                    z !== A &&
                    (G = p4({ Qla: y, TD: x.id, KU: z }));
                  G = z_b({ MJa: G, TD: x.id, KU: A });
                  l("field_results_created", u);
                  q4(() => {
                    a.Xl(() => ({
                      mz: t({ gf: A, GF: A, results: G }),
                      F1: !0,
                    }));
                  });
                  l("submission_set", u);
                  ...
                  if (H.ok)
                    return q4(() => {
                      const K = (M) => {
                        var Q;
                        return (Q = H.value[0]) === null || Q === void 0
                          ? void 0
                          : Q.eBb.includes(M);
                      };
                      a.Xl(() => ({
                        F1: !1,
                        settings: { ...a.Ej.settings, Mba: K },
                        mz: t({ Dwa: void 0 }),
                      }));
                    });
                  d === null ||
                    ...
                    __c.Jj(d, {
                      Wt: O("izckBA"),
                      group: A_b,
                      YQ: { Yw: O("mQhziQ"), onClick: h },
                    });
                  var I = p4({ Qla: G, TD: x.id, KU: A });
                  z && (I = z_b({ MJa: I, TD: x.id, KU: z }));
                  q4(() => {
                    a.Xl({
                      ...B,
                      ...(z && { mz: t({ gf: z, GF: z, results: I }) }),
                    });
                  });
                } else u.abort();
              else u.abort();
            ...
            async function k(v) {
              ...
              const x = r(),
                y =
                  (u = a.Oe.fields.first(({ value: B }) => {
                    var G;
                    return !(
                      (G = B.options.first(({ value: H }) => H.id === v)) ===
                        null ||
                      G === void 0 ||
                      !G.value
                    );
              ...
              if (y) {
                var A = a.Ej,
                  z = p4({ Qla: x.results, TD: y.id, KU: v });
                q4(() => {
                  a.Xl(() => ({
                    mz: t({ gf: void 0, GF: void 0, results: z }),
                    Uw: void 0,
                    F1: !0,
                  }));
                });
            ...
            return {
              ...
              Oha: function (v) {
                const u = r(),
                  x =
                    p === "poll" &&
                    v === (u === null || u === void 0 ? void 0 : u.gf) &&
                    v === (u === null || u === void 0 ? void 0 : u.GF);
                if (g() && x) k(v);
                else if (
                  g() &&
                  a.Oe.fields.some(({ value: A }) =>
          ...
          p4 = function ({ Qla: a, TD: b, KU: c }) {
            var d;
            const e =
              (d = a.fields.get(b)) !== null && d !== void 0
                ? d
                : { id: b, aJ: new Map(), total: 0 };
            var f;
            d = Math.max(
              0,
              ((f = e.aJ.get(c)) !== null && f !== void 0 ? f : 0) - 1
            );
            f = new Map(e.aJ);
          ...
          s4 = function (a, b) {
            var c;
            return (((c = a.Zha) === null || c === void 0
              ? void 0
              : c.get(a.document.language || "en")) || [])[C_b[b]];
          },
          D_b = async function () {
            var { qCa: a } = await __webpack_require__
              .me(535189)
              .then(() => ({
              ...
              m.push({
                ...
                placement: a
                  ? {
                      ...
                      gridRowStart: `${p + q}`,
                      gridRowEnd: `${p + q + 1}`,
                      padding: t.padding ? E_b(t.padding) : void 0,
          ...
          E_b = function (a) {
            switch (a.length) {
              ...
              case 1:
                return a[0];
              case 2:
                return { ra: a[0], Ka: a[1], Fa: a[0], qa: a[1] };
              case 4:
                return { ra: a[0], Ka: a[1], Fa: a[2], qa: a[3] };
              default:
          ...
          w4 = function (a, b) {
            ...
            __c.w(!0);
            __c.w(!0);
            const { ma: c, a: d, b: e } = __c.kt(a),
              { ma: f, a: g, b: h } = __c.kt(b),
              k = (c + f) / 2;
            ...
            var m = d * (1 + l),
              ...
              q = Math.hypot(n, h);
            l = (p + q) / 2;
            var r = __c.et((Math.atan2(e, m) * 180) / Math.PI);
            const t = __c.et((Math.atan2(h, n) * 180) / Math.PI);
          ...
          y4 = function (a, b) {
            ...
            b != null && a.sh(b);
            return { type: "text", lC: 1, text: __c.Dk.ka(a) };
          },
          z4 = function (a) {
            switch (a) {
              case "l":
          ...
          H_b = function ({ direction: a, text: b, background: c }) {
            return {
              id: "header",
              size: "auto",
              fill: c,
          ...
          I_b = function (a, b, c) {
            switch (a) {
              case 0:
                return { type: "color", color: b, Ia: 0.92 };
              case 1:
              case 5:
                return { type: "color", color: b, Ia: 0.88 };
              case 2:
                return { type: "color", color: b, Ia: 0.74 };
              case 3:
                return { type: "color", color: b, Ia: c ? 0.5 : 0.92 };
              case 4:
                return { type: "color", color: b, Ia: 0.92 };
              default:
                throw new E(a);
            ...
            switch (b) {
              ...
              case 1:
                return {
                  type: "text",
                  lC: 1,
                  text: B4(a.messages.loading(), c, d, u4(e, N_b), f),
                };
              case 2:
                return {
                  type: "text",
              ...
              case 3:
                return {
                  type: "text",
                  lC: 1,
                  text: B4(a.messages.offline(), c, d, u4(e, O_b), f),
                };
              case 4:
                return {
                  type: "text",
                  lC: 1,
                  text: B4(
                    s4(a.messages, "somethingWentWrong") || O("ElTceA"),
                    c,
                    d,
                    u4(e, P_b),
                    f
          ...
          R_b = function ({
            ...
            f =
              f.status === 1
                ? ((h = f.zza) === null || h === void 0 ? void 0 : h.type) ===
                  "ANON"
                  ? s4(b, "yourNameWontBeShared") || O("Gzs/9g")
                  : s4(b, "yourNameWillBeShared") || O("WjcAyg")
                : s4(b, "live") || O("/iw6+Q");
            d = (h = s4(b, "numVotes"))
              ? q_b(h, [d], b.document.language)
              : __c.Ob("6QpLYA", [d]);
            return [
              {
                id: "footer",
          ...
          V_b = function ({ direction: a, Fva: b, mw: c, state: d }) {
            const e = w4("#000000", c);
            return {
              type: "layout",
              gridTemplateRows: ["10px", "1fr", "10px"],
              ...
              cells: [
                {
                  ...
                  content: (() => {
                    switch (d) {
                      ...
                      case 4:
                        return y4(b, { direction: A4(a), color: u4(c, U_b) });
                      default:
          ...
          T_b = function (a, b) {
            switch (a) {
              ...
              case 3:
                return { type: "color", color: b, Ia: 0.74 };
              case 4:
                return { type: "color", color: b, Ia: 0.9 };
              case 5:
                return { type: "color", color: "#e3fff0", Ia: 0 };
              case 6:
                return { type: "color", color: "#ffd9df", Ia: 0 };
              default:
                throw new E(a);
            }
          },
                  ...
                  return {
                    ...
                    content: {
                      ...
                      onMouseUp: () => {
                        ...
                        return a === null || a === void 0
                          ? void 0
                          : (u = a.xda) === null || u === void 0
                          ? void 0
                          : u.call(a, p.id);
                      },
                      ...V_b({ direction: b, Fva: p.label, mw: k, state: q }),
                    },
                  };
                }),
              }),
          ...
          X_b = function ({ direction: a, text: b, O7a: c, xR: d, bN: e }) {
            const f = v4.includes(c),
              { h: g, s: h, ma: k } = __c.cka(c);
            var l = new __c.$s(g, h, k < 10 ? k + 6 : k - 6);
            l = __c.mt(l);
            var m = new __c.$s(g, h, k < 10 ? k + 10 : k - 10);
            m = __c.mt(m);
            return {
              id: "submit",
              size: "auto",
              ...
              content: F_b({
                ...
                onMouseEnter: e === null || e === void 0 ? void 0 : e.Yta,
                onMouseLeave: e === null || e === void 0 ? void 0 : e.Zta,
                onMouseDown: e === null || e === void 0 ? void 0 : e.Xta,
                onMouseUp: e === null || e === void 0 ? void 0 : e.$ta,
                background: {
                  type: "color",
                  color: d === 2 ? m : d === 1 ? l : c,
                  Ia: (e === null || e === void 0 ? 0 : e.submit)
                    ? f
                      ? 0.1
                      : void 0
                    : 0.6,
            ...
            if (!m || !h || !k) {
              ...
              h =
                (h === null || h === void 0 ? void 0 : h.status) === 1
                  ? ((p = h.zza) === null || p === void 0 ? void 0 : p.type) ===
                    "ANON"
                    ? s4(c, "yourNameWontBeShared") || O("Gzs/9g")
                    : s4(c, "yourNameWillBeShared") || O("WjcAyg")
                  : void 0;
              return [
                X_b({ direction: b, text: e, O7a: k, xR: n, bN: a }),
                {
                  id: "quiz_status",
                  size: "auto",
                  padding: [8, 20, 10, 20],
        ...
        __c.yD.prototype.fwa = __c.fa(12, function () {
          return __c.tD(this, () => __c.fD(this.operators, "%", this.value));
        });
        var $_b = class {
            constructor() {
              this.type = "layout";
        ...
        var l4 = class {
            ...
            toArray() {
              return this.jKa.map(({ value: a }) => a);
            }
            first(a) {
              const b = this.list.value.first(
                a ? (c) => a(b4(this, c)) : void 0
              );
              if (b != null) return b4(this, b);
            }
            last(a) {
            ...
            constructor(a, b) {
              this.kw = b;
              this.l0a = (l4.A(this), new WeakMap());
              this.e0a = new WeakMap();
              __c.C(a.type === "list");
              this.list = a;
            }
          },
          v_b = class extends l4 {
            replace(a, b) {
              a = c4(this, a);
              b = this.list.value.replace(a, this.kw.Bk(b));
              return b4(this, b);
            }
            XM(a, b) {
              a = a != null ? c4(this, a) : void 0;
              b = this.list.value.XM(a, this.kw.Bk(b));
              return b4(this, b);
            }
            YM(a, b) {
              a = a != null ? c4(this, a) : void 0;
              return this.list.value
                .YM(
                  a,
                  b.map((c) => this.kw.Bk(c))
                )
                .map((c) => b4(this, c));
            }
            insertBefore(a, b) {
              a = a != null ? c4(this, a) : void 0;
              b = this.list.value.insertBefore(a, this.kw.Bk(b));
              return b4(this, b);
            }
            append(a) {
              a = this.list.value.append(this.kw.Bk(a));
              return b4(this, a);
            }
            prepend(a) {
              a = this.list.value.prepend(this.kw.Bk(a));
              return b4(this, a);
            }
            delete(a) {
              a = c4(this, a);
            ...
            FD(a) {
              this.list.value.FD(a ? (b) => a(b4(this, b)) : void 0);
            }
            Sr(a, b) {
              a = a == null ? void 0 : c4(this, a);
              b = c4(this, b);
              this.list.value.Sr(a, b);
            }
          };
        ...
        var d0b = k4({
          ...
          E4 = n4({ text2: d0b }, (a) => a.type),
          e0b = k4({ id: ["i", f4("")], label: ["l", E4] }),
          f0b = m4(e0b),
          g0b = m4(f4("")),
          h0b = k4({
        ...
        h4(["poll", "quiz"], "quiz");
        var q0b = n4({ quiz: o0b, poll: p0b }, (a) => a.type);
        var y_b = {
          ...
          Fe(a) {
            return __c.hs({
              ...
              action: a.action,
              location: a.location,
              linked_design_id: a.MHb,
              toggle_value: a.OF,
              editing_context: a.Tc == null ? void 0 : __c.is(a.Tc),
              performance_context: a.Wc == null ? void 0 : __c.js(a.Wc),
            });
          },
        };
        var A_b = Symbol("UNABLE_TO_SUBMIT");
        var C_b = {
            resultsPercentage: 0,
        ...
        var s0b = class {
          ...
          get border() {
            ...
            return { weight: a.border.weight, color: a.border.color, jXa: a.X };
          }
          constructor(a, b) {
            this.ux = a;
            this.H = b;
        ...
        var t0b = class {
          static A(a) {
            __c.P(a, { Ky: j4, $y: j4, KB: j4, mw: j4 });
          }
          get Ky() {
            const a = this.ux.Oe.Ky.color,
              b = this.ux.Oe.Ky.eb;
            if (a) return { type: "color", color: a };
            if (b.ref) return { type: "gradient", eb: b.ref };
          }
          get $y() {
            const a = this.ux.Oe.$y.color,
              b = this.ux.Oe.$y.eb;
            if (a) return { type: "color", color: a };
            if (b.ref) return { type: "gradient", eb: b.ref };
          }
        ...
        u0b = ({ xlb: a, L$a: b }) => {
          ...
          return (a.status === 1 && b.status === 1 && a.ena !== b.ena) || c;
        };
        __c.kPa = {
          l$a: function (a, b, c, d, e, f, g, h, k) {
            g.tg("forms");
            const { FFb: l } = d !== null && d !== void 0 ? d : {},
              m = h.zv("ui.rendering.form"),
              n = { root: new $_b(), option: new $_b() },
              p = new r0b(b);
            return {
              Nra: c0b,
              kw: q0b,
                ...
                if (l && a) {
                  var r,
                    t = b0b(
                      ...
                      () => {
                        const u = q.Oe.type,
                          x = l.get({ hqa: q.Oe.id, ig: a, Y$: c });
                        r === null || r === void 0 || r.unsubscribe();
                        u === "poll" &&
                          (r = x
                            .NHb({ cGb: () => q.Oe.iC })
                            .subscribe(({ results: y, iC: A }) => {
                              q4(() => {
                        ...
                        x.getSettings({ bGb: () => q.Oe.OV }).subscribe((y) => {
                          ...
                          if (
                            ...
                            const H =
                              (G =
                                (B = q.Oe.fields.first()) === null ||
                                B === void 0
                                  ? void 0
                                  : B.value.P9a.toArray()) !== null &&
                              G !== void 0
                                ? G
                                : [];
                            z = {
                          ...
                          u0b({ xlb: z, L$a: A }) &&
                            x.pFb({ iC: q.Oe.iC, OV: q.Oe.OV }).then(
                              a0b((H) => {
                                const I = q.Oe.iC;
                                if (H.ok) {
                                  ...
                                  if (H.value) {
                                    ...
                                    var T =
                                      (Q =
                                        (M = q.Oe.fields.first()) === null ||
                                        M === void 0
                                          ? void 0
                                          : M.value.id) !== null && Q !== void 0
                                        ? Q
                                        : "";
                                    var V;
                                    ({ gf: M } =
              ...
              render: (q, r) => {
                var t = x_b(q);
                if (l && a) {
                  var v = l.get({ hqa: q.Oe.id, ig: a, Y$: c });
                  v = B_b(q, t, v, e, f, m);
                }
                a: {
                  var u = q.Oe,
                  ...
                  switch (u.type) {
                    ...
                    case "quiz":
                      ...
                      z = A.direction;
                      var Q =
                        (B = A.fields.first()) === null || B === void 0
                          ? void 0
                          : B.value;
                      if (Q && M && u) {
                        B = x4(M);
                        ...
                        M = A.vra
                          ? void 0
                          : H_b({ direction: z, text: Q.label, background: M });
                        Q = W_b({
                          bN: G_b(v),
                          direction: z,
                          options: Q.options,
...
//# sourceMappingURL=sourcemaps/aef096f459b31bbc.js.map
